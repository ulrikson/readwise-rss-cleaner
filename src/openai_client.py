...
USER_PROMPT = (
    "Below is a list of documents, each with an 'id' and a 'title'.\n"
    "Documents: {documents}\n\n"
...
SYSTEM_PROMPT = (
    ...
    "You will receive a list of documents, each with an 'id' and a 'title'.\n"
    ...
    "Exclude documents if their title is about, related to, or a clear example of an exclusion topic.\n\n"
